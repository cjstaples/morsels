import axxpairs.combo.combinatorics
import axxpairs.combo.mypairs
...
class Pairs:
    ...
    def add_sequence(self, seq):
        for i in range(1, self.__n + 1):
            for comb in axxpairs.combo.combinatorics.xuniqueCombinations(seq, i):
                self.add(comb)
    ...
    def count_new_combs(self, seq):
        s = set([key(z) for z in axxpairs.combo.combinatorics.xuniqueCombinations(seq, self.__n)]) - self.__combs_arr[
            -1]
        return len(s)
